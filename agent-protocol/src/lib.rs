    ...
    pub fn capability(&self) -> Option<Capability> {
        match self {
            OperationInput::ReadContext(rc) => Some(match &rc.kind {
                ...
                ContextKind::FileDirectoryResolve(_) => Capability::FileMetadataRead,
...
pub enum ContextKind {
    ...
    FileDirectoryResolve(computer_use::FileDirectoryResolveParams),
...
pub enum ReadContextOutput {
    ...
    FileDirectoryResolve(computer_use::FileDirectoryResolveOutput),
