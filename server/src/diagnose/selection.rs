...
//!   collected at all (security model §3.3 / §9).
...
/// Server-side gate on what evidence may leave the host for the model. Sourced
/// from `AiModelSettings` at collection time.
