...
mod tests {
    ...
    fn gui_guidance_uses_bilingual_search_and_native_lifetimes() {
        ...
        assert!(text.contains("localized labels together with English candidates"));
