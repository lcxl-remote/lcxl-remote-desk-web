...
This project is in early development. Treat your deployment environment as security-sensitive: ensure your network is secure, restrict access to trusted users, and keep API keys server-side (the design enforces this — see the [AI Security Model](/security/ai-security-model)).
