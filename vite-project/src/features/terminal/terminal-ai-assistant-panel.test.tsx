...
import { TerminalAiAssistantPanel, type AssistantExecControls } from "./terminal-ai-assistant-panel";
import type { CommandSuggestion, AssistantState } from "./use-terminal-ai-assistant";
...
function stubExec(entries: Record<number, ExecEntry> = {}): AssistantExecControls {
    return {
        entries,
...
describe("TerminalAiAssistantPanel exec promotion", () => {
    ...
    it("marks the assistant answer as AI-generated even without provenance (Art.50(2), fail-closed)", () => {
    ...
    it("preserves history reading and offers a jump to the latest content", () => {
        renderPanel([suggestion()]);
        const scrollArea = screen.getByTestId("terminal-ai-assistant-scroll-area");
    ...
    it("can be widened by dragging its left separator", () => {
        ...
        const separator = screen.getByRole("separator", {
            name: "Resize Terminal AI Assistant panel",
        }) as HTMLDivElement;
