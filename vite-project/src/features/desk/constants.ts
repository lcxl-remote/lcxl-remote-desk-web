...
export const SIGNALING_TYPE_CODE_ASK_TERMINAL_AI_ASSISTANT = 617;
export const SIGNALING_TYPE_CODE_TERMINAL_AI_ASSISTANT_UPDATED = 618;
export const SIGNALING_TYPE_CODE_CANCEL_TERMINAL_AI_ASSISTANT = 619;
...
export const SIGNALING_TYPE_CODE_ASK_AI_ASSISTANT = 633;
export const SIGNALING_TYPE_CODE_AI_ASSISTANT_UPDATED = 634;
export const SIGNALING_TYPE_CODE_CANCEL_AI_ASSISTANT = 635;
export const SIGNALING_TYPE_CODE_GET_AI_ASSISTANT_CAPABILITIES = 636;
export const SIGNALING_TYPE_CODE_AI_ASSISTANT_CAPABILITIES_UPDATED = 637;
export const SIGNALING_TYPE_CODE_UPDATE_AI_ASSISTANT_CONTEXT = 638;
export const SIGNALING_TYPE_CODE_AI_ASSISTANT_CONTEXT_UPDATED = 639;
export const SIGNALING_TYPE_CODE_UPDATE_AI_ASSISTANT_OBJECT_CONTEXT = 640;
export const SIGNALING_TYPE_CODE_AI_ASSISTANT_OBJECT_CONTEXT_UPDATED = 641;
export const SIGNALING_TYPE_CODE_SELECT_AI_ASSISTANT_SESSION = 643;
export const SIGNALING_TYPE_CODE_AI_ASSISTANT_SESSION_SELECTED = 644;
export const SIGNALING_TYPE_CODE_REQUEST_DOCUMENT_PREVIEW_PAGE = 649;
export const SIGNALING_TYPE_CODE_DOCUMENT_PREVIEW_PAGE_UPDATED = 650;

// Host-to-central lifecycle checks; controller requests never consume these.
export const SIGNALING_TYPE_CODE_QUERY_COMPUTER_ACTION_TURN = 651;
export const SIGNALING_TYPE_CODE_COMPUTER_ACTION_TURN_STATUS = 652;
