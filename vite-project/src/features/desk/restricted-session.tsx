...
//   - Owner-plane entries (settings, AI Assistant, virtual display) are hidden in a
...
export interface RestrictedSession {
    ...
    // Whether owner-plane entries (settings / AI Assistant / virtual display) should show.
