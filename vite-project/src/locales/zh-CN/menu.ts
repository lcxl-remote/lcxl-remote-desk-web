export default {
  ...
  'menu.account.loggingOut': '正在退出…',
  'menu.account.logoutFailed': '退出登录失败，请重试。',
  'menu.editor': '图形编辑器',
  ...
  'menu.settings.aiModel': 'AI 模型设置',
  'menu.settings.aiPolicy': '本地 AI 策略',
  'menu.settings.signalToken': '信令接入令牌',
