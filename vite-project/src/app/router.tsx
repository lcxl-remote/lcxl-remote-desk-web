    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                lazy: async () => ({ Component: (await import('@/features/desk/ai-assistant-conversations')).default }),
            },
            {
            ...
            {
                path: 'desk/:id/browser-setup',
                lazy: async () => ({
                    Component: (await import('@/features/desk/browser-setup-page')).default,
                }),
            },
            {
