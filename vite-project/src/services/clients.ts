...
function getCreateBrowserExtensionPairingUrl() {
  const res = { method: 'POST', url: `/api/desk/browser-extension/pairing` as const }
  return res
}
 ...
 */
export async function createBrowserExtensionPairing(data: CreateBrowserExtensionPairingMutationRequest, config: Partial<RequestConfig<CreateBrowserExtensionPairingMutationRequest>> & { client?: Client } = {}) {
  const { client: request = fetch, ...requestConfig } = config

  const requestData = data

  const res = await request<CreateBrowserExtensionPairingMutationResponse, ResponseErrorConfig<CreateBrowserExtensionPairing500>, CreateBrowserExtensionPairingMutationRequest>({ method : "POST", url : getCreateBrowserExtensionPairingUrl().url.toString(), data : requestData, ... requestConfig })
  return res.data
}
...
function getQueryServiceOperationUrl(operation_id: QueryServiceOperationPathParams["operation_id"]) {
  const res = { method: 'GET', url: `/api/service/operations/${operation_id}` as const }
  return res
}
 ...
 */
export async function queryServiceOperation(operation_id: QueryServiceOperationPathParams["operation_id"], config: Partial<RequestConfig> & { client?: Client } = {}) {
  const { client: request = fetch, ...requestConfig } = config



  const res = await request<QueryServiceOperationQueryResponse, ResponseErrorConfig<QueryServiceOperation404>, unknown>({ method : "GET", url : getQueryServiceOperationUrl(operation_id).url.toString(), ... requestConfig })
  return res.data
}
