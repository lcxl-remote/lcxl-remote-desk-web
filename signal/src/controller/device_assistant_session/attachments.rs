...
use desk_signal_facade::controller::device_assistant_attachment::*;
...
#[get("/my/device-assistant-session/attachments")]
...
#[get("/my/device-assistant-session/attachment")]
...
#[post("/my/device-assistant-session/attachments/delete")]
...
#[post("/my/device-assistant-session/attachment/read")]
